%Este script ejecuta un entrenamiento de una red neuronal para control por
%modelo de referencia. No se usa el toolbox NN de MATLAB para la
%configuración y entrenamiento de la red neuronal. Todas las funciones
%fueron implementadas por Juan Pablo Requez, juanrequez@gmail.com
